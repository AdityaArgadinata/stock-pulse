...
wp_enqueue_style( 'magaznews-fonts', wptt_get_webfont_url( magaznews_fonts_url() ), array(), null );
...
// blocks.
wp_enqueue_style( 'magaznews-blocks-style', get_template_directory_uri() . '/assets/css/blocks.min.css' );

// style.
wp_enqueue_style( 'magaznews-style', get_template_directory_uri() . '/style.css', array(), MAGAZNEWS_VERSION );

// navigation.
wp_enqueue_script( 'magaznews-navigation', get_template_directory_uri() . '/assets/js/navigation.min.js', array(), MAGAZNEWS_VERSION, true );
...
// Custom script.
wp_enqueue_script( 'magaznews-custom-script', get_template_directory_uri() . '/assets/js/custom.min.js', array( 'jquery' ), MAGAZNEWS_VERSION, true );
