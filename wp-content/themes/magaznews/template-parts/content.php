...
$archive_category = get_theme_mod( 'magaznews_enable_archive_category', true );
$archive_author   = get_theme_mod( 'magaznews_enable_archive_author', true );
$archive_date     = get_theme_mod( 'magaznews_enable_archive_date', true );
?>
	...
	<div class="single-card-container grid-card">
		...
		<div class="single-card-detail">
			...
			<div class="post-exerpt">
				<?php echo wp_kses_post( wp_trim_words( get_the_excerpt(), get_theme_mod( 'magaznews_excerpt_length', 15 ) ) ); ?>
			</div><!-- post-exerpt -->
		</div>
	</div>
